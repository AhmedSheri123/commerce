...
SECRET_KEY = 'django-insecure-^f8+gr%rxj)ju0*y-8)$s$wx*mk1e5a&1det=uv82arh@@^q#q'
...
INSTALLED_APPS.append('management')
...
MIDDLEWARE = [
    ...
    'accounts.middleware.SurveyRequiredMiddleware',
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'accounts.context_processors.active_users_count',
            ],
        },
    },
]
