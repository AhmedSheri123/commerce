...
class PlatformModel(models.Model):
    ...
    show_to_all = models.BooleanField(default=False, verbose_name="اعرض للجميع", help_text="اذا تم تفعيل هذا الخيار، سيتم عرض المنصة لجميع المستخدمين بغض النظر عن الاعدادات الاخرى.")
